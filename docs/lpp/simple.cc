...
namespace Loci {
  ...
  // $type cr Map
  //comments 1
  class file_simple000_1608568559m152 : public Loci::unit_rule {
    store<char>  firstOrderCells ; 
public:
    file_simple000_1608568559m152() {
...
register_rule<file_simple000_1608568559m152> register_file_simple000_1608568559m152 ;


  
  class file_simple001_1608568559m153 : public Loci::apply_rule< store<char> ,Loci::Maximum<char> >  {
    const_store<Loci::real_t>  vol ; 
    const_Map cl ; 
    const_Map cr ; 
    store<char>  firstOrderCells ; 
public:
    file_simple001_1608568559m153() {
       name_store("firstOrderCells",firstOrderCells) ;
       name_store("vol",vol) ;
       name_store("cl",cl) ;
       name_store("cr",cr) ;
...
register_rule<file_simple001_1608568559m153> register_file_simple001_1608568559m153 ;
  ...
  class file_simple002_1608568559m154 : public Loci::pointwise_rule {
    const_store<real>  X ; 
...
register_rule<file_simple002_1608568559m154> register_file_simple002_1608568559m154 ;

  
  // $type face2node multiMap
  // $type NGTNodalv3dMax(X0) store<vector3d<real_t> >  
 
  class file_simple003_1608568559m154 : public Loci::apply_rule< store<vector3d<real_t> > ,Loci::Maximum<vector3d<real_t> > >  {
    const_Map cl ; 
    const_store<real>  X ; 
...
register_rule<file_simple003_1608568559m154> register_file_simple003_1608568559m154 ;
