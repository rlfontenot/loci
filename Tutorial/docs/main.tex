...
Parametric rules are defined by parametric variables.  A parametric
variable is one that has parameters as defined by a parenthesized list
of substitution keys.  Thus, for example, if we want to create a cell
integration of some variable, we can provide that using the paremetric
variable {\tt cellIntegrate(X)}
