...
namespace Loci {
  ...
  /// @brief FAD Second derivative type
  class FAD2d {
  public:
    double value;
    double grad;
...
// --------------------------------------------------------------------
 ...
 inline FAD2d max (const FAD2d &a, const FAD2d & b) {
    FAD2d out((a.value<b.value)?b.value:a.value);
    out.grad = (a.value<b.value)?b.grad:a.grad;
    out.grad2 = (a.value<b.value)?b.grad2:a.grad2;
    return out;
  }
  inline FAD2d max (const FAD2d &a, const int& b) {
    return max(a,FAD2d((double)b));
  }
  inline FAD2d max (const FAD2d &a, const float& b) {
    return max(a,FAD2d((double)b));
  }
  inline FAD2d max (const FAD2d &a, const double & b) {
    return max(a,FAD2d((double)b));
  }
  inline FAD2d max (const FAD2d &a, const long double & b) {
    return max(a,FAD2d((double)b));
  }
  inline FAD2d min (const FAD2d &a, const FAD2d& b) {
    FAD2d out((a.value<b.value)?a.value:b.value);
    out.grad = (a.value<b.value)?a.grad:b.grad;
    out.grad2 = (a.value<b.value)?a.grad2:b.grad2;
    return out;
  }
  inline FAD2d min (const FAD2d &a, const int& b) {
    return min(a, FAD2d((double)b));
  }
  inline FAD2d min (const FAD2d &a, const float& b) {
    return min(a, FAD2d((double)b));
  }
  inline FAD2d min (const FAD2d &a, const double& b) {
    return min(a, FAD2d((double)b));
  }
  inline FAD2d min (const FAD2d &a, const long double& b) {
    return min(a, FAD2d((double)b));
  }
  ...
  inline FAD2d sqrt(const FAD2d u) {
    ...
    double tol = 1e-30;
    return FAD2d(su,0.5*u.grad/std::max(su,tol),
                 0.5*u.grad2/(std::max(su,tol)) - 0.25*u.grad*u.grad/(std::max(su*su*su,tol)));
  }
  inline FAD2d pow(const FAD2d k, const FAD2d u) {
...
inline FADd max (const FADd &a, const FADd& b) {
    FADd out((a.value<b.value)?b.value:a.value);
    out.grad = (a.value<b.value)?b.grad:a.grad;
    return out;
  }
  inline FADd max (const FADd &a, const int& b) {
    return FADd(::max(a,FADd((double)b)));
  }
  inline FADd max (const FADd &a, const float& b) {
    return FADd(::max(a,FADd((double)b)));
  }
  inline FADd max (const FADd &a, const double & b) {
    return FADd(::max(a,FADd((double)b)));
  }
  inline FADd max (const FADd &a, const long double & b) {
    return FADd(::max(a,FADd((double)b)));
  }
  inline FADd min (const FADd &a, const FADd& b) {
    FADd out((a.value<b.value)?a.value:b.value);
    out.grad = (a.value<b.value)?a.grad:b.grad;
    return out;
  }
  inline FADd min (const FADd &a, const int& b) {
    return FADd(::min(a, FADd((double)b)));
  }
  inline FADd min (const FADd &a, const float& b) {
    return FADd(::min(a, FADd((double)b)));
  }
  inline FADd min (const FADd &a, const double& b) {
    return FADd(::min(a, FADd((double)b)));
  }
  inline FADd min (const FADd &a, const long double& b) {
    return FADd(::min(a, FADd((double)b)));
  }
  ...
  inline FADd sqrt(const FADd u) {
    double su = std::sqrt(u.value);
    double tol = 1e-30;
    return FADd(su,0.5*u.grad/std::max(su,tol));
  }
  inline FADd pow(const FADd k, const FADd u) {
    double kpu = std::pow(k.value,u.value);
