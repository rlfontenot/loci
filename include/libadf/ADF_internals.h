...
#define LIST_CHUNK_GROW_FACTOR	       1.5
   ...
   /** File parameters **/
#ifndef MAX_FWRITE_BUFFERSIZE
#define MAX_FWRITE_BUFFERSIZE	  (10 * 1024 * 1024)  /* 10MB */
#endif
...
ADFLIB_EXPORT void    ADFI_string_2_C_string(
	    const char *string,
