...
/*****************************************************************************/
/*                                                                           */
/*  fcompress()  compress an expansion.                                      */
/*                                                                           */
...
int fcompress(int elen, REAL *e, REAL *h)                         /* e and h may be the same. */
{
  REAL Q, q;
  INEXACT REAL Qnew;
  int eindex, hindex;
...
/**
*************************************************************************
* The following code is NOT part of the original geometric predicates
* by Jonathan Richard Shewchuk. It is added for use within a mesh
* utility program. Code added by Yang Zhang (fz15@ERC.MsState.EDU)
**/

/************************************************************************/
/*                                                                      */
/*  cross2dfast()   Approximate 2D cross sign test.  Nonrobust.         */
/*  crosst2dexact() Exact 2D cross sign test.  Robust. (but slow)       */
/*  An adaptive version is in planning...                               */
/*                                                                      */
/*  The arguments to the above functions are v1b, v1e, v2b, v2e. All    */
/*  are REAL points. The above functions compute the sign of the cross  */
/*  product cross(v1,v2) for vectors defined by v1=(v1b-v1e),           */
/*  v2=(v2b-v2e). v1b and v1e means the head point and tail point of    */
/*  v1 respectively, the same holds for v2b and v2e.                    */
/*                                                                      */
/*          Return a positive value if the cross product is positive;   */
/*          a negative value if the cross product is negative;          */
/*          and zero if the cross product is zero. The result is also   */
/*          a rough approximation of the real cross product.            */
/*                                                                      */
/************************************************************************/

REAL cross2dfast(REAL *v1b, REAL *v1e, REAL *v2b, REAL *v2e)
{
...
REAL cross2dexact(REAL *v1b, REAL *v1e, REAL *v2b, REAL *v2e)
{
  INEXACT REAL v1x, v2y, v1y, v2x ;
  REAL v1xtail, v2ytail ;
  REAL v2xtail, v1ytail ;
  REAL negate, negatetail ;
  REAL v1xv2y[8], v1yv2x[8] ;
  INEXACT REAL v1xv2y7, v1yv2x7 ;
  REAL deter[16] ;
  int deterlen ;
  ...
  Two_Diff(v1b[0], v1e[0], v1x, v1xtail) ;
  Two_Diff(v2b[1], v2e[1], v2y, v2ytail) ;
  Two_Diff(v1b[1], v1e[1], v1y, v1ytail) ;
  Two_Diff(v2b[0], v2e[0], v2x, v2xtail) ;

  Two_Two_Product(v1x, v1xtail, v2y, v2ytail,
                  v1xv2y7, v1xv2y[6], v1xv2y[5],
                  v1xv2y[4], v1xv2y[3], v1xv2y[2],
                  v1xv2y[1], v1xv2y[0]) ;
  v1xv2y[7] = v1xv2y7 ;
  negate = -v1y ;
  negatetail = -v1ytail ;

  Two_Two_Product(negate, negatetail, v2x, v2xtail,
                  v1yv2x7, v1yv2x[6], v1yv2x[5],
                  v1yv2x[4], v1yv2x[3], v1yv2x[2],
                  v1yv2x[1], v1yv2x[0]) ;
  v1yv2x[7] = v1yv2x7 ;
  
  deterlen = fast_expansion_sum_zeroelim(8, v1xv2y, 8, v1yv2x, deter) ;
