...
// throw an HDF5DatatypeInterfaceException if invoked.
void PredType::commit( H5Object& loc, const string name )
{
   throw HDF5DatatypeInterfaceException( "Attempting to commit a predefined datatype.  This operation is invalid" );
}  

bool PredType::committed()
{
   throw HDF5DatatypeInterfaceException( "Attempting to check for commit status on a predefined datatype.  This operation is invalid" );
}  
