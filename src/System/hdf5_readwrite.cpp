...
namespace Loci {
  ...
  namespace hdf5_const {
    const int PPN(1);
    const int facc_type(FACC_MPIO);		/*Test file access type */
    const int dxfer_coll_type(DXFER_COLLECTIVE_IO); /*use collective IO*/
    // const int dxfer_coll_type(DXFER_INDEPENDENT_IO); /*use independent IO*/
  }
