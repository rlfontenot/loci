...
namespace Loci {
  ...
  public:
    ...
    UNIT_type(const UNIT_type &ut) {
      unit_kind = ut.unit_kind ;
      input_unit = ut.input_unit ;
      mode = ut.mode ;
      input_value = ut.input_value ;
      value=ut.value;
      unit_num_map=ut.unit_num_map;
      unit_den_map=ut.unit_den_map;
