...
class FADd {
 public:
  ...
  operator FADd() {return FADd(value,grad);}
  ...
  operator long double*()  {return (long double*)&value;}
...
#define gradcheck() 
 ...
 FADd(bool &u)        : value((u)?1.0d:0.0d), grad(0.0d) { gradcheck();}
 FADd(const FADd &u) : value(u.value), grad(u.grad) { gradcheck();}
 FADd(int a0)        : value(a0), grad(0.0d) { gradcheck();}
 FADd(float a0)        : value(a0), grad(0.0d) { gradcheck();}
 FADd(double a0)        : value(a0), grad(0.0d) { gradcheck();}
 FADd(long double a0)        : value(a0), grad(0.0d) { gradcheck();}
...
/* MPGCOMMENT [05-12-2017 15:05] ---> MIN/MAX */
inline FADd max (const FADd &a, const FADd& b) {
  return FADd( (a.value<b.value)?b.value:a.value,
	       (a.value<b.value)?b.grad:a.grad );
}
inline FADd max (const FADd &a, const int& b) {
  return max(a,FADd((double)b,0.0d));
}
...
inline FADd min (const FADd &a, const FADd& b) {
  return FADd( (a.value<b.value)?a.value:b.value,
	       (a.value<b.value)?a.grad:b.grad );
}
inline FADd min (const FADd &a, const int& b) {
  return min(a, FADd((double)b, 0.0d));
}
...
/* template <class RC> const RC& max (const RC &a, const RC& b) { */
/*   return FADd( (a.value<b.value)?b.value:a.value, */
/* 	       (a.grad<b.grad)?b.grad:a.grad ); */
/* } */

/* template <class RC> const RC& min (const RC &a, const RC& b) { */
/*   return FADd( (a.value<b.value)?a.value:b.value, */
/* 	       (a.grad<b.grad)?a.grad:b.grad ); */
/* } */


/* typedef FADd real; */

/* FADd operator +(const double &u,const FADd &v) { */
