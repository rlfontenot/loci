...
class merge_tmpface_gh:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fr;
...
register_rule<merge_tmpface_gh> register_merge_tmpface_gh;


class merge_tmpface_hg:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fl;
  const_store<Array<char,6> > orientCode;
...
register_rule<merge_tmpface_hg> register_merge_tmpface_hg;

class merge_tmpface_gp:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fr;
...
register_rule<merge_tmpface_gp> register_merge_tmpface_gp;

class merge_tmpface_pg:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fl;
  const_store<Array<char,5> > orientCode;
...
register_rule<merge_tmpface_pg> register_merge_tmpface_pg;


class merge_tmpface_hp:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fl;
  const_store<char> fr;
...
register_rule<merge_tmpface_hp> register_merge_tmpface_hp;

class merge_tmpface_ph:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fl;
  const_store<char> fr;
...
register_rule<merge_tmpface_ph> register_merge_tmpface_ph;
