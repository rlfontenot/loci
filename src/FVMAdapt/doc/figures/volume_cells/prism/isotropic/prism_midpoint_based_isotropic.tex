...
% Face-based isotropic refinement of a triangular prism.
...
\begin{tikzpicture}[
  ...
  \foreach \p in {fABC,fDEF,fABED,fADFC,fBCEF} {
  ...
  % Red face-centroid splits on all five original faces.
  ...
  \foreach \p in {mAB,mBE,mDE,mAD} {
    \draw[split] (fABED) -- (\p);
  }
  \foreach \p in {mAD,mFD,mCF,mCA} {
    \draw[split] (fADFC) -- (\p);
  }
  \foreach \p in {mBE,mBC,mCF,mEF} {
    \draw[split] (fBCEF) -- (\p);
  }
