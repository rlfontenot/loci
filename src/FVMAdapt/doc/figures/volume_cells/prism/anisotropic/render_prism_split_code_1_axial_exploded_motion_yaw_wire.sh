...
tex_file="$script_dir/prism_split_code_1_axial_exploded.tex"
base_name=prism_split_code_1_axial_exploded_motion_yaw_wire
out_gif="$script_dir/${base_name}.gif"

work_dir=$(mktemp -d "${TMPDIR:-/tmp}/fvmadapt-prism-code1-motion-yaw-wire.XXXXXX")
