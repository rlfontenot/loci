...
class merge_derefineface_gh:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fr;
...
register_rule<merge_derefineface_gh> register_merge_derefineface_gh;


class merge_derefineface_hg:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fl;
  const_store<Array<char,6> > orientCode;
...
register_rule<merge_derefineface_hg> register_merge_derefineface_hg;

class merge_derefineface_gp:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fr;
...
register_rule<merge_derefineface_gp> register_merge_derefineface_gp;

class merge_derefineface_pg:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fl;
  const_store<Array<char,5> > orientCode;
...
register_rule<merge_derefineface_pg> register_merge_derefineface_pg;


class merge_derefineface_hp:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fl;
  const_store<char> fr;
...
register_rule<merge_derefineface_hp> register_merge_derefineface_hp;

class merge_derefineface_ph:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fl;
  const_store<char> fr;
...
register_rule<merge_derefineface_ph> register_merge_derefineface_ph;
