...
class merge_interior_face:public pointwise_rule{
  const_Map cl;
  const_Map cr;
  const_store<char> fl;
  const_store<char> fr;
...
register_rule<merge_interior_face> register_merge_interior_face;




class merge_boundary_face:public pointwise_rule{
  const_Map cl;
...
register_rule<merge_boundary_face> register_merge_boundary_face;
