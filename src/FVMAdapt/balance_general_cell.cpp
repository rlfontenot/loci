...
class init_cell_updated:public pointwise_rule{
...
register_rule<init_cell_updated> register_init_cell_updated;



//this rule balance each cell with all its interior faces(lower, upper)
class advance_cell_updated : public pointwise_rule{
...
register_rule<advance_cell_updated> register_advance_cell_updated;
